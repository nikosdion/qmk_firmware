...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        L_T_ONF, L_BRI,    L_PTN,  L_PSI,   L_T_PTD, _______, _______, U_T_AUTO,U_T_AGCR,_______, KC_PSCR, KC_SLCK, KC_PAUS, _______, KC_VOLD, \
        L_T_MD,  L_BRD,    L_PTP,  L_PSD,   L_T_BR,  _______, _______, _______, _______, _______, _______, _______,          _______, KC_MUTE, \
        _______, AG_NORM, AG_TOGG, _______, _______, MD_BOOT, NK_TOGG, DBG_TOG, KC_MPRV, KC_MNXT, KC_MPLY, _______,          KC_PGUP, KC_EJCT, \
