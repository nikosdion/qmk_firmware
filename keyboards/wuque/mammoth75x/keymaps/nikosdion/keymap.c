...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_75_ansi_split_rshift(
        ...
        KC_LCTL, KC_LALT, KC_LGUI,                          KC_SPC,                               KC_RGUI, KC_RALT, KC_APPLE_FN,      KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [1] = LAYOUT_75_ansi_split_rshift(
        RESET,   KC_BRID, KC_BRIU, LAG(KC_SPC), KC_F13, LSG(KC_4), LSG(KC_5), KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_VOLD, KC_VOLU, KC_INS,  KC_MPLY,
    ...
    [3] = LAYOUT_75_ansi_split_rshift(
        RESET,   KC_BRID, KC_BRIU, _______, _______, _______, _______, KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_VOLD, KC_VOLU, KC_INS,       KC_MPLY,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_DEL,
